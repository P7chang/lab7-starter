...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let markupArticle = document.createElement('article');

		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component

		let markupStyle = document.createElement('style');
		...
		shadowDOM.append(markupArticle);
		shadowDOM.append(markupStyle);
	}
	...
	set data(data) {
		...
		let selectArticle = this.shadowRoot.querySelector('article');
